...
static const char *googlecmd[] = { "google-chrome-unstable", "--incognito", NULL};
...
static const char *tabbycmd[] = { "tabby", NULL };
static const char *fehcmd[] = { "random-feh", NULL };
...
static const char *extendRightcmd[] = { "xrandr", "--output", "HDMI-1-1", "--right-of", "eDP-1", "--auto", NULL };
static const char *extendLeftcmd[] = { "xrandr", "--output", "HDMI-1-1", "--left-of", "eDP-1", "--auto", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t,      spawn,          {.v = tabbycmd } },
	{ MODKEY|ControlMask,           XK_f,      spawn,          {.v = fehcmd } },
	{ MODKEY,                       XK_q,      spawn,          {.v = qqcmd } },
	{ MODKEY,                       XK_n,      spawn,          {.v = nvimcmd } },
	{ MODKEY|ShiftMask,             XK_x,      spawn,          {.v = extendLeftcmd } },
	{ MODKEY|ControlMask,           XK_x,      spawn,          {.v = extendRightcmd } },
